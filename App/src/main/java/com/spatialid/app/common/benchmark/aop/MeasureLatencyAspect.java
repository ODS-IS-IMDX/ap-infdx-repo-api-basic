...
public class MeasureLatencyAspect {
    ...
    public MeasureLatencyAspect(MessageSource messageSource) {
     ...
     * @return 対象メソッドの返却値
     * @throws Throwable 対象メソッドに送出された例外
     */
    ...
    public Object measureLatency(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info(messageSource.getMessage(LoggingConstant.KEY_INFO_MSG_MEASURE, new String[] {targetName, latency}, Locale.JAPAN));
